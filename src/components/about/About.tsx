...
import PageHeader from '../DetailsPage/Pageheader';
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-foreground/80 mb-4">
                At LeadPoint, our mission is to empower businesses with cutting-edge marketing strategies that deliver tangible results. We believe in building strong partnerships with our clients, understanding their unique needs, and crafting tailored solutions that foster growth and maximize return on investment.
              </p>
